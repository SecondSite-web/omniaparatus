<?php
/*
 * This is a modified class of the original. Added methods for quick table generation
 * Modified by SecondSite.xyz
 *
 * PHP-PDO-MySQL-Class
...
class DB
{
     ...
     * @return array
     */
    private function col_names($query, $params = null)
    {
        $this->Init($query, $params);
        $resultColumn = $this->sQuery->fetchAll(PDO::FETCH_COLUMN);
        return $resultColumn;
    ...
    /**
     * Fetch entire table contents
     * @param $tablename
     * @param null $params
     * @return array
     */
    public function fetch_table($tablename, $params = null) {
        return $this->query("SELECT * FROM {$tablename}", $params = null);
    }
    /**
     * Custom function - fetch column names
     * @param $tablename
     * @param null $params
     * @return array
     */
    public function table_headings($tablename, $params = null) {
        return $this->col_names("DESCRIBE {$tablename}", $params = null);
    }
    /**
     * @param $query
     * @param null $params
